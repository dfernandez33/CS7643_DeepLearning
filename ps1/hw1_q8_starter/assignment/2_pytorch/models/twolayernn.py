...
class TwoLayerNN(nn.Module):
    def __init__(self, im_size, hidden_dim, n_classes):
        ...
        #############################################################################
        self.layer_1 = nn.Linear(np.prod(im_size), hidden_dim)
        self.ReLU = nn.ReLU()
        self.layer_2 = nn.Linear(hidden_dim, n_classes)
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
    ...
    def forward(self, images):
        ...
        #############################################################################
        imgs = images.view(-1, images.shape[1] * images.shape[2] * images.shape[3])
        scores = self.layer_2(self.ReLU(self.layer_1(imgs)))
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
        return scores
